...
app.state.config.CONFLUENCE_URL = CONFLUENCE_URL
app.state.config.CONFLUENCE_SPACE_KEY = CONFLUENCE_SPACE_KEY
app.state.config.CONFLUENCE_USERNAME = CONFLUENCE_USERNAME
app.state.config.CONFLUENCE_API_TOKEN = CONFLUENCE_API_TOKEN
